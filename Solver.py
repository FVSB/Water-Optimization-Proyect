...
class Solver:
    ...
    def Solve(process_1: Process, process_2: Process, Water_from_1_to_2: float, Water_From_2_1, Price_transport_water: float, Leader_Water_price: float, Water_Leader_supply: float, Fresh_Water_Contamination: float = 0.0):
