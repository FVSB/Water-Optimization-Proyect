...
class Process:  # Please with the name of the process write the company that is going to do it
    def __init__(self, Name: str, Company: str, C_Max_In: float, C_Max_Out: float, Cant_Water: float, State_Max_Water_Supply: float, Sale_Price_State_Supply: float, Time_of_Test: float, Process_To_send: dict, Price_discharge_water: float):
        self.Name = Name
