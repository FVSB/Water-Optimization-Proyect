...
# Creacion de Intermediario


def CreateIntermediary():
    price = float(input("Precio del Agua del Lider: "))
    return Intermediary(CreateCompany(int(input("Cuantos Empresas Desea Crear?"))), price)
...
for i in range(len(arrayProcess)):
    process = arrayProcess[i]
