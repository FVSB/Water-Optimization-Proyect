...
def Solve_Numerical(a, b, d, h, Consumo_1, Consumo_2, Con_Concen_1, Con_Concen_2, Array_initial: list, epsilon=0.01):
    # Variables
    x = symbols('x')
    y = symbols('y')
    z_1 = symbols('z_1')
    ...
    d_10 = -m_5*z_2
    d_11 = m_6*(y-x-z_2)
    d_12 = C_max_2*(z_2+y)-(C_max_1*x)-m_2
   # d_13 = m_7*(Consumo_1-z_1-y)
   # d_14 = m_8*(Consumo_2-z_2-x)
